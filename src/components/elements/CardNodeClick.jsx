...
import {
  selectEdgeLabelCount,
  selectEdgesCount,
  selectGraphData,
  selectNodeLabelCount,
  selectNodesCount,
  selectSelectedNode,
...
const CardNodeClick = () => {
  ...
  useEffect(() => {
    const containerHeight =
      nodePropertiesRef.current?.parentElement?.clientHeight;
    if (containerHeight) {
    ...
    >
      ...
      >
        {Object.entries(properties).map(([key, value], index) => (
          ...
          >
            <div
              style={{ flex: "50%", fontWeight: "bold", paddingLeft: "8px" }}
            >
              {key}
            </div>
